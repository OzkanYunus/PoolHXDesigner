...
We are designing a pool, because of that, we get water inlet in certain small degree range and we want water outlet in certain small degree range.

Since we cannot change the outlet water temperature and we are expecting to get a certain outlet temperature, and mdot values are more or less known in industry,
what we can do for get correct desing is that iterating h design values until both preliminary design and main part gives within range of +-100 W/mK h values,
which is tolerable range. 
